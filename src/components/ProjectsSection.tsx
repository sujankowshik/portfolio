...
const PROJECTS: ProjectData[] = [
  {
    ...
    liveUrl: 'https://apex-vest.onrender.com/',
    col1Image1: '/fin_dashboard_1.png',
    col1Image2: '/fin_dashboard_2.png',
    col2Image: '/fin_dashboard_3.png',
  },
  {
    number: '02',
    category: 'Personal · Full Stack',
    name: 'eCommerce & Admin Dashboard',
    liveUrl: 'https://ecommerce-storefront-1ez7.onrender.com/',
    col1Image1: '/ecommerce_1.png',
    col1Image2: '/ecommerce_2.png',
    col2Image: '/ecommerce_3.png',
  },
  {
    number: '03',
    category: 'Personal · Machine Learning',
    name: 'House Price Prediction',
    liveUrl: 'https://aurapred.onrender.com/',
    col1Image1: '/house_predict_1.png',
    col1Image2: '/house_predict_2.png',
    col2Image: '/house_predict_3.png',
  },
];
